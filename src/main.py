...
query = f'abs:(diagram\sgeneration OR text-to-diagram OR figure\sgeneration OR text-to-figure OR code\sgeneration OR text-to-code) AND cat:(cs.CL OR cs.CV OR cs.PL) AND submittedDate:[{dt_start} TO {dt_end}]'
