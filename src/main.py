...
query = f'abs:(diagram_generation OR text-to-diagram OR figure_generation OR text-to-figure OR code_generation OR text-to-code) AND cat:(cs.CL OR cs.CV OR cs.PL) AND submittedDate:[{dt_start} TO {dt_end}]'
