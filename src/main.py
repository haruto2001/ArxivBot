...
query = f'(diagram generation OR text-to-diagram OR figure generation OR text-to-figure OR code generation OR text-to-code) AND cat:(cs.CL OR cs.CV OR cs.PL) AND submittedDate:[{dt_start} TO {dt_end}]'
